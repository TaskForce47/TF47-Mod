 ...
 * Called by TF47_breachingCharge_fnc_breachObstacle
 *
 * Arguments:
 * 0: Position <OBJECT>
 * 1: House <OBJECT>
 ...
 *
 * Example:
 * [_pos, _house] call TF47_breachingCharge_fnc_nearestDoor;
 * [getPos get3DENCamera, nearestObject [getPos get3DENCamera, "HOUSE"], 20] call TF47_breachingCharge_fnc_nearestDoor;
 */
