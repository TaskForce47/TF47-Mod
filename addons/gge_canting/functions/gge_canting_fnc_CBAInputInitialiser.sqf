////// GGE_CANTING BINDS ///////
[
	"Goobin's Gameplay Enhancements Canting", "gge_canting_var_toggleCantMode", 
...
[
    ...
    "Goobin's Gameplay Enhancements Canting", // Pretty name of the category where the setting can be found. Can be stringtable entry.
...
["GGE Canting CBA Controls and Settings succesfully initialised!"] call gge_core_fnc_debugLog;
