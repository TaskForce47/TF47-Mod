...
gge_canting_fnc_cantAim = compile preprocessFileLineNumbers "z\TF47\addons\gge_canting\functions\fn_gge_canting_cantAim.sqf";
gge_canting_fnc_decantAim = compile preprocessFileLineNumbers "z\TF47\addons\gge_canting\functions\fn_gge_canting_decantAim.sqf";


// Initialise input
waituntil {!isnull (finddisplay 46)};
gge_canting_fnc_initInput = call compile preprocessFileLineNumbers "z\TF47\addons\gge_canting\functions\fn_gge_canting_inputInitialiser.sqf";


// Initialise canting animation situations handler
gge_canting_fnc_animationHandler = compile preprocessFileLineNumbers "z\TF47\addons\gge_canting\functions\fn_gge_canting_animationHandler.sqf";
...
gge_canting_fnc_CBAInputInitialiser = call compile preprocessFileLineNumbers "z\TF47\addons\gge_canting\functions\fn_gge_canting_CBAInputInitialiser.sqf";
