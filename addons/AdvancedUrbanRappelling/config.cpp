...
class CfgFunctions 
{
   class SA
   {
      class AdvancedUrbanRappelling
      {
         file = "\AdvancedUrbanRappelling\functions";
...
class CfgSounds
{
   class AUR_Rappel_Loop
   {
      ...
      sound[] = {"\AdvancedUrbanRappelling\sounds\AUR_Rappel_Loop.ogg", db+5, 1};
      titles[] = {0,""};
   };
   class AUR_Rappel_Start
   {
      name = "AUR_Rappel_Start";
      sound[] = {"\AdvancedUrbanRappelling\sounds\AUR_Rappel_Start.ogg", db+10, 1};
      titles[] = {0,""};
   };
   class AUR_Rappel_End
   {
      name = "AUR_Rappel_End";
      sound[] = {"\AdvancedUrbanRappelling\sounds\AUR_Rappel_End.ogg", db+10, 1};
      titles[] = {0,""};
   };
};
