class CfgWeapons
{
        ...
        class AUR_rope30: CBA_MiscItem {
                scope = 2;
                GVAR(ropeLength) = 30;
                picture = "z\TF47\addons\AdvancedUrbanRappelling\assets\rope_Icon";
        ...
        class AUR_AnchorKit: CBA_MiscItem {
                scope = 2;
                picture = "z\TF47\addons\AdvancedUrbanRappelling\assets\anchor_Icon";
        ...
        class AUR_BelayDevice: CBA_MiscItem {
                scope = 2;
                picture = "z\TF47\addons\AdvancedUrbanRappelling\assets\belay_Icon";
