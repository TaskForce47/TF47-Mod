...
class CfgMovesMaleSdr: CfgMovesBasic
{
   class States
   {
      ...
      class AR_01_Aim: ar_cargo_base_Rope
      {
         ...
         leftHandIKCurve[]={1};
         minPlayTime = 0.1;                        
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aim.rtm";   /// what file is going to be played in this state
         speed=100000;                                 
         ConnectTo[]={};                                 
         InterpolateTo[]=                              
         {
      ...
      class AR_01_Aim_Idling: AR_01_Aim
      {
         ...
         headBobStrength=0;
         soundEnabled=1;
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aim1.rtm";
         speed=-8;                                    
         ConnectTo[]=
         {
            "AR_01_Aim",
      ...
      class AR_01_Idle: ar_cargo_base_idle
      {
         ...
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_idle.rtm";
         speed=100000;
         minPlayTime = 0.1;
      ...
      class AR_01_Idle_Idling: AR_01_Idle
      {
         ...
         headBobStrength=0;
         soundEnabled=1;
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_idle1.rtm";
         speed=-10;
         ConnectTo[]=
         {
            "AR_01_Idle",
      ...
      class AR_01_Aim_Pistol: ar_cargo_basepistol
      {
         ...
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aimpistol.rtm";
      ...
      class AR_01_Aim_Pistol_Idling: AR_01_Aim_Pistol
      {
         ...
         headBobStrength=0;
         soundEnabled=1;
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aimpistol1.rtm";
         speed=-8;
         ConnectTo[]=
         {
            "AR_01_Aim_Pistol",
      ...
      class AR_01_Idle_Pistol: ar_cargo_base_idle_pistol
      {
         ...
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_idlepistol.rtm";
         speed=100000;
         aiming="aimingRifleSlingDefault";
         aimingBody="aimingUpRifleSlingDefault";
         InterpolateTo[]=
      ...
      class AR_01_Idle_Pistol_Idling: AR_01_Idle
      {
         ...
         headBobStrength=0;
         soundEnabled=1;
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_idlepistol1.rtm";
         speed=-10;
         ConnectTo[]=
         {
            "AR_01_Idle_Pistol",
      ...
      {
         actions="AR_01_PistolActions";
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aimtopistol.rtm";
         speed=2;
         ConnectTo[]=
         {
      ...
      {
         actions="AR_01_PistolActions";
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aimtopistol_end.rtm";
         speed=1.875;
         ConnectTo[]=
         {
            "AR_01_Aim_Pistol",
      ...
      {
         actions="AR_01_PistolActions";
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aimFrompistol.rtm";
         speed=2.3076921;
         ConnectTo[]=
         {
      ...
      {
         actions="AR_01_Actions";
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_aimfrompistol_end.rtm";
         aiming="aimingDefault";
      ...
      class AR_01_Die: DefaultDie
      {
         ...
         file="z\TF47\addons\AdvancedRappelling\anims\Rup_RopeFX_01_die.rtm";
         speed=1;
         looped="false";
         terminal=1;
         ragdoll=1;
