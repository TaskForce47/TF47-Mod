...
// Unload All Action
private _unloadAllAction = ["TF47_UnloadAll", 
            ...
            _fnc_conditions,
            {
                ...
                if(ace_interact_menu_selectedTarget isEqualTo _patient) then {
                    ...
                    if([_patient] call FUNC(isUnconscious) || !alive _patient) then {
                        ...
                        private _action = ["TF47_Unload", [LSTRING(Incapacitated,Unload)] call FUNC(cachedLocalisationCall), QUOTE(ICON_PATH(unload)), {
